...
void automatic_run(){
	switch(status){
		...
		case AUTO_RED_3s:
			...
			HAL_GPIO_WritePin(Tracffic_1B_GPIO_Port, Tracffic_1B_Pin, GPIO_PIN_SET);
			//tracffic 2 xanh
			HAL_GPIO_WritePin(Tracffic_2A_GPIO_Port, Tracffic_1A_Pin, GPIO_PIN_SET);
			HAL_GPIO_WritePin(Tracffic_2B_GPIO_Port, Tracffic_1B_Pin, GPIO_PIN_RESET);
		...
		case AUTO_RED_2s:
			...
			HAL_GPIO_WritePin(Tracffic_1B_GPIO_Port, Tracffic_1B_Pin, GPIO_PIN_SET);
			//tracffic 2 vang
			HAL_GPIO_WritePin(Tracffic_2A_GPIO_Port, Tracffic_1A_Pin, GPIO_PIN_RESET);
			HAL_GPIO_WritePin(Tracffic_2B_GPIO_Port, Tracffic_1B_Pin, GPIO_PIN_RESET);
		...
		case AUTO_GREEN:
			...
			//tracffic 2 do
			HAL_GPIO_WritePin(Tracffic_2A_GPIO_Port, Tracffic_1A_Pin, GPIO_PIN_RESET);
			HAL_GPIO_WritePin(Tracffic_2B_GPIO_Port, Tracffic_1B_Pin, GPIO_PIN_SET);
			if(timer1_flag == 1){
				status = AUTO_YELLOW;
				setTimer1(200);
			}
